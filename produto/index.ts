...
novoCamisa.setPreco = readLine.questionInt("Digite o novo preco: ");
novoSorvete.setTempAdequada = readLine.questionInt("Digite a nova temperatura adequada: ")
